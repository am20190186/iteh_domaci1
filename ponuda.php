      ...
      <div class="we_do slin">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Pretraga nasih proizvoda </h2>
                  </div>
               </div>
            </div>
            <div class="row">
                <div class="col-12">
                    ...
                    <hr>
                    <button onclick="pretrazi()" class="btn btn-dark">Pretrazi</button>
                </div>
        ...
        function vratiBrendove(){
            $.ajax({
                ...
                success: function (data){
                    let podaci = '<option value="0"> Svi brendovi</option>' + data;
                    $("#brendovi").html(podaci);
                    pretrazi();
                }
            });
        }
